...
type Location = "brand" | "s200" | "s600"
export const Location: Record<Location, string> = {
  s200: "#BDEA4B",
  brand: "#7FE855",
  s600: "#417F3C",
}
...
type Episodes = "brand" | "s200" | "s600"
export const Episodes: Record<Location, string> = {
  s200: "#447AE6",
  brand: "#67C0E6",
  s600: "#1634F5",
}

type Characters = "brand" | "s200" | "s600"
export const Characters: Record<Location, string> = {
  s200: "#B13FE6",
  brand: "#783FE6",
  s600: "#8F20D1",
}
