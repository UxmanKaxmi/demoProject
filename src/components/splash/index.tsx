...
export const AnimatedBootSplash = ({ onAnimationEnd }: Props) => {
  ...
  const { container, logo /*, brand */ } = BootSplash.useHideAnimation({
    manifest: require("@assets/splash-screen/bootsplash_manifest.json"),
    logo: require("@assets/splash-screen/bootsplash_logo.png"),
    // darkLogo: require("../assets/bootsplash_dark_logo.pang"),
